...
var characterState = {
  create: function () {
    this.choice = game.add.text(1100, 100, "Choix du personnage", {
      font: fontxl,
      fill: textColor,
    });
    game.add
    ...
    this.achilleName = game.add.text(400, game.world.centerY + 160, "Achille", {
      font: fontxl,
      fill: textColor,
    });
    ...
    this.ernestName = game.add.text(400, game.world.centerY + 160, "Ernest", {
      font: fontxl,
      fill: textColor,
    });
  ...
  transitionAnimation: function (pState) {
    game.add
      .tween(this.choice)
      .to({ x: this.choice.x - 800 }, 400, Phaser.Easing.Linear.Out, true);
    game.add
      .tween(this.achille)
      .to({ x: this.achille.x - 800 }, 400, Phaser.Easing.Linear.Out, true);
    game.add
      .tween(this.ernest)
      .to({ x: this.ernest.x - 800 }, 400, Phaser.Easing.Linear.Out, true);
    game.add
      .tween(this.returnButton)
      .to(
