...
var helpState = {
  ...
  transitionAnimation: function () {
    ...
    game.add
      .tween(this.coin)
      .to({ x: this.coin.x - 800 }, 400, Phaser.Easing.Linear.Out, true);
    game.add
      .tween(this.coinText)
      .to({ x: this.coin.x - 800 }, 400, Phaser.Easing.Linear.Out, true);
    game.add
      .tween(this.potion)
      .to({ x: this.potion.x - 800 }, 400, Phaser.Easing.Linear.Out, true);
    game.add
      .tween(this.potionText)
      .to({ x: this.coin.x - 800 }, 400, Phaser.Easing.Linear.Out, true);
    game.add
      .tween(this.enemy1)
      .to({ x: this.enemy1.x - 800 }, 400, Phaser.Easing.Linear.Out, true);
    game.add
      .tween(this.enemy1Text)
      .to({ x: this.enemy1Text.x - 800 }, 400, Phaser.Easing.Linear.Out, true);
    game.add
      .tween(this.enemy2)
      .to({ x: this.enemy2.x - 800 }, 400, Phaser.Easing.Linear.Out, true);
    game.add
      .tween(this.enemy2Text)
