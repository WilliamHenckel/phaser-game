...
var levelState = {
  init: function (map) {
    ...
    switch (game.conf.difficulty) {
      ...
      default:
        game.conf.difficultyData = JSON.parse(
          this.game.cache.getText("casual")
        );
    }
  },
  ...
  displayText: function () {
    this.level = game.add.text(
      400,
      game.world.centerY - 75,
      "World 1 - " + game.conf.mapName,
    ...
    switch (game.conf.mapName) {
      ...
      case 2:
        this.tutoLabel = game.add.text(
          400,
          game.world.centerY + 75,
          "Goal : " + game.conf.difficultyData.score + " points",
