...
var loadState = {
  preload: function () {
    let progressBar = game.add.sprite(
      game.world.centerX,
      game.world.centerY,
      "progressBar"
    );
    ...
    game.load.audio("castelvania", [
      "assets/castelvania.mp3",
      "assets/castelvania.ogg",
    ]);
    game.load.audio("potion", ["assets/powerup.ogg", "assets/powerup.mp3"]);
    game.load.audio("boom", ["assets/laser.ogg", "assets/laser.mp3"]);
    game.load.audio("bossDieSound", [
      "assets/bossDie.ogg",
      "assets/bossDie.mp3",
    ]);
    game.load.audio("bossHurtSound", [
      "assets/bossHurt.ogg",
      "assets/bossHurt.mp3",
    ]);
    game.load.audio("enemyDieSound", [
      "assets/enemyDie.ogg",
      "assets/enemyDie.mp3",
    ]);
    game.load.audio("explosion", [
